...
class SP2 : public Scene
{
	...
	enum GEOMETRY_TYPE
	{
		...
		GEO_GOLD_SWORD_MODEL,
		GEO_WOODEN_AXE_MODEL,
		GEO_STONE_AXE_MODEL,
		GEO_GOLD_AXE_MODEL,
		GEO_WOODEN_PICKAXE_MODEL,
		GEO_STONE_PICKAXE_MODEL,
		GEO_GOLD_PICKAXE_MODEL,
		GEO_WOODEN_HOE_MODEL,
		GEO_STONE_HOE_MODEL,
		GEO_GOLD_HOE_MODEL,
...
public:
	...
	void TalkToServer(std::string s);
	void ListToServer();
...
private:
	...
	// create thread for listner 
	std::thread Thread;

	std::vector<std::string> MESSAGES;
	std::vector<std::string> MESSAGES_USE;
	std::vector<std::string> MESSAGES_WORLDITEM;
